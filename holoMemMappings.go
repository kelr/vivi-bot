...
var (
	...
	OmgMemNameMappings = map[string]RegExpEmojiKVP{
		...
		"noefure":          newOmgMemKVP("noefure|noeflare", [][]string{OmgNoelEmojis, OmgFlareEmojis}),
		"aqupeko":          newOmgMemKVP("aqupeko|akupeko", [][]string{OmgAquaEmojis, OmgPekoEmojis}),
		"pekovivi":         newOmgMemKVP("pekovivi", [][]string{OmgPekoEmojis, OmgViviEmojis}),
		"pekomiko":         newOmgMemKVP("pekomiko", [][]string{OmgPekoEmojis, OmgMikoEmojis}),
		"soraz":            newOmgMemKVP("soraz", [][]string{OmgSoraEmojis, OmgAzkiEmojis}),
		"nepolabo":         newOmgMemKVP("nepolabo", [][]string{OmgNeneEmojis, OmgPolkaEmojis, OmgLamyEmojis, OmgBotanEmojis}),
		"smok":             newOmgMemKVP("smok", [][]string{OmgSubaruEmojis, OmgMioEmojis, OmgOkayuEmojis, OmgKoroneEmojis}),
		"umisea":           newOmgMemKVP("umisea", [][]string{OmgAquaEmojis, OmgMarineEmojis, OmgChloeEmojis, OmgGuraEmojis, OmgInaEmojis}),
		"ayafubumi":        newOmgMemKVP("ayafubumio?", [][]string{OmgAyameEmojis, OmgFubukiEmojis, OmgMioEmojis}),
		"shiranuikensetsu": newOmgMemKVP(`shiranui[-\s]?kensetsu`, [][]string{OmgSuiEmojis, OmgMikoEmojis, OmgFlareEmojis, OmgPolkaEmojis, OmgNoelEmojis}),
		"usadakensetsu":    newOmgMemKVP(`usada[-\s]?kensetsu`, [][]string{OmgPekoEmojis, OmgMoonaEmojis, OmgCocoEmojis, OmgRushiaEmojis, OmgTowaEmojis, OmgKiaraEmojis, OmgKanataEmojis}),
		"akukinkensetsu":   newOmgMemKVP(`akukin[-\s]?kensetsu`, [][]string{OmgAquaEmojis, OmgMarineEmojis, OmgMioEmojis, OmgMelEmojis, OmgAkiroseEmojis, OmgChocoEmojis, OmgFlareEmojis, OmgIofiEmojis, OmgNeneEmojis, OmgLamyEmojis, OmgKanataEmojis}),
		"dorobokensetsu":   newOmgMemKVP(`dorobo[-\s]?kensetsu`, [][]string{OmgOkayuEmojis, OmgMioEmojis, OmgFubukiEmojis, OmgLuiEmojis, OmgKoroneEmojis, OmgLaplusEmojis}),
		"kanaken":          newOmgMemKVP("kanaken", [][]string{OmgKanataEmojis, OmgAzkiEmojis, OmgChloeEmojis}),
		"holotori":         newOmgMemKVP("holotori", [][]string{OmgLuiEmojis, OmgSubaruEmojis, OmgKiaraEmojis, OmgReineEmojis, OmgMumeiEmojis}),
		"fams":             newOmgMemKVP("fams", [][]string{OmgFubukiEmojis, OmgAyameEmojis, OmgMioEmojis, OmgSubaruEmojis}),
		"okfams":           newOmgMemKVP("okfams", [][]string{OmgOkayuEmojis, OmgKoroneEmojis, OmgFubukiEmojis, OmgAyameEmojis, OmgMioEmojis, OmgSubaruEmojis}),
		"startend":         newOmgMemKVP("startend", [][]string{OmgSuiEmojis, OmgAquaEmojis, OmgTowaEmojis}),
		...
		"gen3":             newOmgMemKVP(`gen[-\s]?3|(san|3)kisei|fantasy`, [][]string{OmgRushiaEmojis, OmgPekoEmojis, OmgFlareEmojis, OmgNoelEmojis, OmgMarineEmojis}),
		"gen4":             newOmgMemKVP(`gen[-\s]?4|(yon|4)kisen|holoforce`, [][]string{OmgWatameEmojis, OmgTowaEmojis, OmgLunaEmojis, OmgKanataEmojis, OmgCocoEmojis}),
		"gen5":             newOmgMemKVP(`gen[-\s]?5|(go|5)kisei|holofive`, [][]string{OmgLamyEmojis, OmgNeneEmojis, OmgBotanEmojis, OmgPolkaEmojis}),
		"holox":            newOmgMemKVP(`holox|gen[-\s]?6|(rok|6)kisei|himitsu\s?kessha\s?horokkusu`, [][]string{OmgLaplusEmojis, OmgLuiEmojis, OmgKoyoriEmojis, OmgIrohaEmojis, OmgChloeEmojis}),
		...
		"holoidgen1":       newOmgMemKVP(`area15`, [][]string{OmgRisuEmojis, OmgMoonaEmojis, OmgIofiEmojis}),
		"holoidgen2":       newOmgMemKVP(`holoro`, [][]string{OmgOllieEmojis, OmgAnyaEmojis, OmgReineEmojis}),
		"holoidgen3":       newOmgMemKVP(`holoh3ro`, [][]string{OmgZetaEmojis, OmgKaelaEmojis, OmgKoboEmojis}),
